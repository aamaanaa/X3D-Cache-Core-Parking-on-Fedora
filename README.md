...
*in the above picture, we run a steam game, and only the X3D cores are active for best performance and latency. The X3D cores 0 to 7 and 16 to23 are the only ones been used by the game, while the other cores are not used or barly used at all.*
